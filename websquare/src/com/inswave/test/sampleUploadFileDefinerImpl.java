 ...
 *
 */
public class sampleUploadFileDefinerImpl extends AbstractUploadFileDefiner {
	...
	public String getFileName( String clientFileName, String originalFileName ) throws Exception {
		...
		if(index > -1) {
			...
			returnFileName = clientFileName.substring(0, index) + "_TEST" + "." + ext;
		} else {
			returnFileName = clientFileName.substring(0) + "_TEST";
		}
